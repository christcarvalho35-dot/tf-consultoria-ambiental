        ...
        <section className="py-20 px-4 bg-[#0D2418]">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Card 1 — Pesquisa EIV */}
              <div className="group bg-[#1a3a28] border border-white/10 rounded-2xl overflow-hidden hover:border-[#4CAF50]/50 hover:shadow-[0_0_40px_rgba(76,175,80,0.12)] transition-all duration-300 flex flex-col">
                {/* Browser mockup */}
                <div className="bg-[#111] rounded-t-2xl overflow-hidden">
                  <div className="flex items-center gap-1.5 px-4 py-3 bg-[#1e1e1e] border-b border-white/5">
                    <span className="w-2.5 h-2.5 rounded-full bg-red-500/70" />
                    <span className="w-2.5 h-2.5 rounded-full bg-yellow-400/70" />
                    <span className="w-2.5 h-2.5 rounded-full bg-green-500/70" />
                    <div className="ml-3 flex-1 bg-[#2a2a2a] rounded-full px-3 py-1 text-[10px] text-gray-500 truncate">
                      pesquisa-eiv-cac.vercel.app
                    </div>
                  </div>
                  <div className="relative bg-gradient-to-br from-[#0a1f14] to-[#1a3a28] h-44 flex items-center justify-center">
                    <div className="text-center space-y-2 opacity-60">
                      <svg className="w-10 h-10 text-[#4CAF50] mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                      </svg>
                      <p className="text-white/40 text-xs">Consulta Pública EIV</p>
                    </div>
                  </div>
                </div>
                {/* Card body */}
                <div className="p-6 flex flex-col gap-4 flex-1">
                  <div className="flex items-center justify-between">
                    <h3 className="text-white font-bold text-lg">Pesquisa EIV</h3>
              ...
              <div className="group bg-[#1a3a28] border border-white/10 rounded-2xl overflow-hidden hover:border-[#4CAF50]/50 hover:shadow-[0_0_40px_rgba(76,175,80,0.12)] transition-all duration-300 flex flex-col">
                ...
                <div className="bg-[#111] rounded-t-2xl overflow-hidden">
                  ...
                  <div className="relative bg-gradient-to-br from-[#0a1f14] to-[#1a3a28] h-44 flex items-center justify-center">
                    <div className="text-center space-y-2 opacity-60">
                      ...
                      <p className="text-white/40 text-xs">Inventário Florestal</p>
                    </div>
                  </div>
                </div>
                {/* Card body */}
                <div className="p-6 flex flex-col gap-4 flex-1">
                  <div className="flex items-center justify-between">
                    <h3 className="text-white font-bold text-lg">Flora Cerrado</h3>
